...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/nathanaellee15/tview)](https://pkg.go.dev/github.com/nathanaellee15/tview)
[![Go Report](https://img.shields.io/badge/go%20report-A%2B-brightgreen.svg)](https://goreportcard.com/report/github.com/nathanaellee15/tview)
...
```bash
go get github.com/nathanaellee15/tview@master
```
...
Check out the [GitHub Wiki](https://github.com/nathanaellee15/tview/wiki) for more examples along with screenshots. Or try the examples in the "demos" subdirectory.
...
Refer to https://pkg.go.dev/github.com/nathanaellee15/tview for the package's documentation. Also check out the [Wiki](https://github.com/nathanaellee15/tview/wiki).
